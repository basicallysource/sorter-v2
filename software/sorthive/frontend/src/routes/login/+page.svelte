...
<div class="flex min-h-[80vh] items-center justify-center">
	<div class="w-full max-w-sm border border-gray-200 bg-white p-8 shadow-sm">
		...
		{#if currentError()}
			<div class="mb-4 bg-red-50 p-3 text-sm text-red-700">{currentError()}</div>
		{/if}
		...
		{#if githubEnabled}
			...
			<a
				...
				class="flex w-full items-center justify-center gap-3 border border-gray-300 px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50"
			>
