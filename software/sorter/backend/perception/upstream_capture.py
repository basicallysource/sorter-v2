...
FIELD_META: list[dict] = [
    {"section": "Collection", "key": "enabled", "label": "Collection enabled", "type": "bool", "default": _DEFAULTS.enabled},
    {"section": "Collection", "key": "collect_ch2", "label": "Collect from C2", "type": "bool", "default": _DEFAULTS.collect_ch2},
    {"section": "Collection", "key": "collect_ch3", "label": "Collect from C3", "type": "bool", "default": _DEFAULTS.collect_ch3},
    {"section": "Collection", "key": "sample_interval_s", "label": "Frame sample interval (s) — embeds all bboxes per sample", "type": "float", "default": _DEFAULTS.sample_interval_s},
    {"section": "Collection", "key": "crop_pad_px", "label": "Crop padding (px)", "type": "int", "default": _DEFAULTS.crop_pad_px},
    {"section": "Collection", "key": "jpeg_quality", "label": "JPEG quality", "type": "int", "default": _DEFAULTS.jpeg_quality},
    {"section": "Collection", "key": "window_seconds", "label": "Rolling window (s)", "type": "int", "default": _DEFAULTS.window_seconds},
    {"section": "Collection", "key": "embed_batch_size", "label": "Embed batch size", "type": "int", "default": _DEFAULTS.embed_batch_size},
    {"section": "Collection", "key": "embed_max_queue", "label": "Max pending crops", "type": "int", "default": _DEFAULTS.embed_max_queue},
    {"section": "Search", "key": "lookback_seconds", "label": "Look back from arrival (s)", "type": "float", "default": _DEFAULTS.lookback_seconds},
    {"section": "Search", "key": "forward_seconds", "label": "Look forward from arrival (s)", "type": "float", "default": _DEFAULTS.forward_seconds},
    {"section": "Search", "key": "min_similarity", "label": "Min similarity (0-1)", "type": "float", "default": _DEFAULTS.min_similarity},
