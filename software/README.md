...
- [../Documentation/runtime-status.md](../Documentation/runtime-status.md) — Current detector benchmark conclusions, deployment recommendations, and canonical local artifacts to keep
- [../Documentation/model-artifacts.md](../Documentation/model-artifacts.md) — Which detector exports and compiled formats exist, what they are for, and how they map to targets
- [client/ARUCO_GUI_USAGE.md](client/ARUCO_GUI_USAGE.md) — Web-based ArUco tag calibration GUI
- [../Documentation/device-benchmarking.md](../Documentation/device-benchmarking.md) — Reproducible detector benchmarking across Mac, Raspberry Pi, and Orange Pi targets
- [../Documentation/hailo-hef-workflow.md](../Documentation/hailo-hef-workflow.md) — `ONNX -> HEF` workflow for Raspberry Pi 5 AI HAT deployments
