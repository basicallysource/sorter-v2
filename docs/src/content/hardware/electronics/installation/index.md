...
- **Two of the three enclosures have never been photographed bolted on.** The control board housing is the only one anybody has a picture of on the frame. The PSU box below is a render rather than a build, and the Orange Pi mount is still a described placeholder. The finished PSU box has no photo on the bench either, so its own page carries a placeholder as well.
