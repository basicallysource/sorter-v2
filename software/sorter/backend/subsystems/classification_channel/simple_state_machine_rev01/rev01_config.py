...
FIELD_META: list[dict] = [
    ...
    {"key": "precise_converge_speed_usteps_per_s", "label": "Move-to-precise converge speed (µsteps/s)", "type": "int", "default": _DEFAULTS.precise_converge_speed_usteps_per_s, "description": "Motor speed for the forward-only converge into the narrow precise staging band. Slower than normal rotation so the approach is gentle; C4 never backs up."},
