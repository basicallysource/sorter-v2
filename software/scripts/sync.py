...
LOCAL_SORTING_PROFILE_PATH = os.getenv(
    "SORTING_PROFILE_PATH",
    "/Users/spencer/Documents/GitHub/sorter-v2/software/client/sorting_profile.json",
)
...
REMOTE_SORTING_PROFILE_PATH = (
    f"/home/{REMOTE_USER}/sorter-v2/software/client/sorting_profile.json"
)
...
def main() -> int:
    ...
    ensureRemoteDir(
        remote,
        str(Path(REMOTE_SORTING_PROFILE_PATH).parent),
    )
