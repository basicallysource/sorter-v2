...
Each entry: what you see → cause → fix → how to verify. For the install procedure itself, see [Install on Linux (generic)]({{ '/sorter/installation/linux-generic/' | relative_url }}).
