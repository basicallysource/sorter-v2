...
**It hangs off a dovetail, not a screw.** The outside of the channel wall carries a row of dovetails. Use the **8th one from the channel exit**, counting anticlockwise seen from above, which is three further round than C2 and C3 use. **It goes on from underneath**: offer the mount up to the bottom edge of the wall, feed its rail into the dovetail and push it up until it clips over the top edge. That is the whole joint, and the mount has no other fixing.
