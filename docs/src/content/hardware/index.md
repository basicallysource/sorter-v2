...
**A 5 layer machine stands 1270 mm from the floor to the top plate**, and
1772 mm to the top of the bulk bucket sitting above it. Each layer you add or
leave off moves both figures by 160 mm, so a 3 layer machine is 950 mm to the
top plate and 1452 mm overall. Check the space before you choose a height: the
