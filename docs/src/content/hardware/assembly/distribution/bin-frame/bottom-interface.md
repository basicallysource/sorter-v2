...
The parts list above is only the Lazy Susan bearing stack and the extrusion mounts added in steps 5 to 10. The fasteners and quantities below are called out inline at each step.
