...
<div class="flex min-h-[80vh] items-center justify-center">
	<div class="w-full max-w-sm border border-[#E2E0DB] bg-white p-8">
		<h1 class="mb-6 text-center text-2xl font-bold text-[#1A1A1A]">Sign in to SortHive</h1>

		{#if currentError()}
			<div class="mb-4 bg-[#FEF2F2] p-3 text-sm text-[#9B1D20]">{currentError()}</div>
		{/if}
		...
		<p class="mt-4 text-center text-sm text-[#7A7770]">
			...
			<a href="/register" class="text-[#D01012] hover:underline">Register</a>
		</p>
	</div>
</div>
