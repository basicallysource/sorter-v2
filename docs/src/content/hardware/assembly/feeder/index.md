...
1. **[Camera lamp]({{ '/hardware/assembly/feeder/camera-lamp/' | relative_url }})**, the arm, light and camera that hang over a channel. Build three, one each for C2, C3 and the classification channel; the bulk channel has none. They come first because the channel pages need them.
