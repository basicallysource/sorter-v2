...
{:else if stats}
	<div class="mb-8 grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-4">
		<div class="border border-gray-200 border-l-4 border-l-gray-300 bg-white p-4">
		...
		<div class="border border-gray-200 border-l-4 border-l-green-500 bg-white p-4">
			<p class="text-sm text-gray-500">Accepted</p>
			<p class="text-2xl font-bold text-green-600">{stats.accepted_samples}</p>
		</div>
		<div class="border border-gray-200 border-l-4 border-l-red-500 bg-white p-4">
			<p class="text-sm text-gray-500">Rejected</p>
			<p class="text-2xl font-bold text-red-600">{stats.rejected_samples}</p>
		</div>
		<div class="border border-gray-200 border-l-4 border-l-yellow-500 bg-white p-4">
