...
lede: The four leads from the control board to the c-channel motors. Move four contacts into a 6-pin housing, or crimp the whole lead from wire. Four per machine.
permalink: /hardware/helpers/channel-stepper-lead/
author: effreek
contributors: [daddyosbricksbill, spencer]
warning: >-
...
parts_needed:
  ...
  - part: jst-phr-6
    qty: 4
tools_needed: ["A fine pick or a sliver of shim", Multimeter, "Only if you crimp from wire: wire strippers and a crimp tool for open-barrel contacts"]
---
...
<div class="callout callout-warning">
  ...
  <p><b>The lead that comes in the box with the motor is not the one you use.</b> Two of its four conductors are in the wrong order for this board, and it ends in a Dupont housing rather than a JST-PH. Keep it as a spare; the rest of this page is the lead that replaces it.</p>
</div>

## Why not the shipped lead
...
<dl class="spec-list">
  <dt>The order is wrong</dt><dd>Two of the four conductors have to change places before the motor turns properly. That is a rewire, not a plug-in.</dd>
...
The motor's own end is fine: it is a 6-position JST-PH socket on the can, and the lead below plugs straight into it.
...
This is the route with no crimping. Start from a ready-made 4-pin PH cable with a PHR-4 on both ends.
