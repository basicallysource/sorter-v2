...
CLASSIFICATION_ROOT = TRAINING_ROOT / "datasets" / "_curated"
DEFAULT_SAMPLE_IDS_JSON = REPORTS_OUT_DIR / "benchmark_reports" / "benchmark-1774996075" / "benchmark_data.json"
...
PRESETS: dict[str, dict[str, Any]] = {
    "chamber_zone_pair": {
        ...
        "model_runs": [
            "runs/20260331-zone-classification_chamber-yolo11s/run.json",
            "runs/20260331-zone-classification_chamber-nanodet/run.json",
        ],
        "sample_ids_json": "reports_out/benchmark_reports/benchmark-1774996075/benchmark_data.json",
    },
    "chamber_pair": {
        ...
        "model_runs": [
            "runs/20260331-234738-chamber-yolo11n-320/run.json",
            "runs/20260331-234738-chamber-nanodet-1-5x-416/run.json",
        ],
        "sample_ids_json": "reports_out/benchmark_reports/benchmark-1774996075/benchmark_data.json",
        "split_source_run": "runs/20260331-234738-chamber-yolo11n-320/run.json",
    },
}
...
def _path_from_client_root(relative_path: str) -> Path:
    return (TRAINING_ROOT / relative_path).resolve()
