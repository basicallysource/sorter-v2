	...
	<div class="flex flex-col gap-3 border border-border bg-bg px-3 py-3">
		...
		<div class="flex flex-wrap items-center gap-2">
			...
			<button
				...
				class="w-full cursor-pointer border border-danger bg-danger/20 px-3 py-1.5 text-sm text-danger hover:bg-danger/30 disabled:cursor-not-allowed disabled:opacity-50 sm:w-auto dark:text-red-400"
			>
