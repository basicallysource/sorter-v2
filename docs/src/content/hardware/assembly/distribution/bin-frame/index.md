...
<ol class="numbered-steps">
  ...
  <li><strong><a href="{{ '/hardware/assembly/distribution/bin-frame/bottom-interface/' | relative_url }}">Bottom interface</a></strong>. The Lazy Susan the bottom of the chute stack sits on. Build it on the bench whenever you like; it is fitted at the very end, <strong>after the chutes are in</strong>.</li>
